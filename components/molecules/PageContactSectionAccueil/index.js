...
function PageContactSectionAccueil() {
    ...
    useEffect(() => {
        ...
        let lt=gsap.timeline({
            ...
            lt.from(".PageContactSectionAccueil .img",{ y:100,duration:1,opacity:0,})
            .from ('.PageContactSectionAccueil .el1',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageContactSectionAccueil .el2',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageContactSectionAccueil .el3',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageContactSectionAccueil .el4',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageContactSectionAccueil .el5',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageContactSectionAccueil .form',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
           ...
           <Row className="pl-0 pl-md-5 ml-0 ml-md-5">
                <Col lg={7} className="align-self-center ">
                    ...
                    <div className="px-2 px-md-5 mx-0 mx-md-5 px-0 px-md-5" style={{position:"relative",zIndex:1}}>
                        <img src="/img/logo.svg" alt="Logo de dubani agency" className="img" height="100" />
                        ...
                        <Texte className="h5 py-2 py-md-3 el3">
                           info@dubaniagency.com
                        </Texte>
                        <Texte className="h5 py-2 py-md-3 el4">
                           RESEAUX SOCIAUX
                        </Texte>
