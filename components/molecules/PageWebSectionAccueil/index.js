...
function PageWebSectionAccueil() {
    ...
    useEffect(() => {
        ...
        let lt=gsap.timeline({
            ...
            lt.from(".PageWebSectionAccueil .pageTitle",{ y:100,duration:1,opacity:0,})
            .from ('.PageWebSectionAccueil .MyTitle',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageWebSectionAccueil .PageText',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageWebSectionAccueil .btn',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", y: 100 })
            .from ('.PageWebSectionAccueil .img1',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", x: -100 })
            .from ('.PageWebSectionAccueil .img2',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", x: 100 })
            .from ('.PageWebSectionAccueil .img3',{duration:1,opacity:0,ease: "slow(0.7, 0.7, false)", x: -100 })
        ...
        <PageWebSectionAccueilStc>
          ...
          <Row className="pt-0 pt-md-0 mt-0 mt-md-0">
                ...
                <Col lg={5} className="right d-none d-lg-block py-0 py-md-5 ">
                    <img src="/img/web-1.png" alt="Maquette Web design, exemple dubani 1" className="img1" width="100%" style={{position:"absolute",left:"0px",top:"100px"}} />
                    <img src="/img/web-2.png" alt="Maquette Web design, exemple dubani 2" className="img2" width="100%" style={{position:"absolute",left:"0px",top:"100px"}}  />
                    <img src="/img/web-3.png" alt="Maquette Web design, exemple dubani 3" className="img3" width="100%" style={{position:"absolute",left:"0px",top:"100px"}}  />
                </Col>
            </Row>
          </Container>
        </PageWebSectionAccueilStc>
